...
//		Thread.sleep(20000);
	 ...
	 * @throws Exception 
	 */
//	public static BigInteger getW_ni(BigInteger W, BigInteger M) throws Exception {
//
//		BigInteger W1 = BigInteger.ONE;
//		while ((W1.multiply(W)).mod(M).compareTo(BigInteger.ONE)!=0) {
//			W1=W1.add(BigInteger.ONE);
