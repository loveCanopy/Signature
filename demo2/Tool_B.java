...
public class Tool_B {
   ...
   public static ArrayList<Long> A=new ArrayList<Long>();
     ...
     * 找到M,W使其满足条件
     * */
    public static ArrayList<Long> MW=new ArrayList<Long>();
    public static long M,W=0;
    public static long P,V=0;
    public static long W1=0;   //W的逆
    /**
     * B序列  B=W×A（MOD M）
     * */
     ...
     * 找到P,V使其满足条件
     * */
    public static ArrayList<Long> PV=new ArrayList<Long>();
    /**
     * 找到∆序列
     * */
     ...
     * 找到D序列
     * */
    public static ArrayList<Long> D=new ArrayList<Long>();
    /*
    * 得到L0,L1
    * */
    public static  ArrayList<Long> L=new ArrayList<>();
    public  static long SB,K,T;
    ...
    //计算L0 L1的值
    public static ArrayList<Long> createL(ArrayList<Long> A,ArrayList<Integer> Q,ArrayList<Long> PV){
        long P=PV.get(0);
        long V=PV.get(1);
        double temp_l0=0.0;
        for(int i=0;i<A.size();i++){
    ...
    //密钥交换  公钥Alice（B,D,M'）,随机选取（x1,x2,x3,...）
    ...
    //解密过程
    public static int[] getSource(long W1,long M,ArrayList<Long> A){
//        ArrayList<Integer> source=new ArrayList<>();
        int[] source=new int[A.size()];
        long Sa=(W1*SB)%M;
        //背包问题找到0和1
     ...
     * @return
     */
    public static char byteAsciiToChar(long ascii){
        char ch = (char)ascii;
        return ch;
    }
