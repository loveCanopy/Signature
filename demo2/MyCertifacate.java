...
public class MyCertifacate {
    private static final String STORE_PASS = "246437";
    private static final String ALIAS = "myCertificate";
    private static final String KEYSTORE_PATH = "/media/yujie/项目/MYJAVA/Signature/src/Signature_test/myKeystore.keystore";
    private static final String CERT_PATH = "/media/yujie/项目/MYJAVA/Signature/src/Signature_test/myCer.cer";
